...
export type Scalars = {
  ...
  algFilterByFields: 'id' | 'algcase.name' | 'algcase' | 'tag' | 'tag.name'
  algGroupBy: 'id'
  tagSortBy: 'id' | 'created_at'
...
export type InputType = {
  ...
  tagFilterByObject: FilterByObject<Scalars['tagFilterByFields']>
  getTagPaginator: {
    first?: Scalars['number']
    last?: Scalars['number']
    after?: Scalars['string']
    before?: Scalars['string']
    sortBy?: Scalars['tagSortBy'][]
    sortDesc?: Scalars['boolean'][]
    filterBy?: InputType['tagFilterByObject'][]
    groupBy?: Scalars['tagGroupBy'][]
    search?: Scalars['string']
  }
...
export type Root = {
  ...
  getTag: { Query: Tag; Response: Tag; Args: InputType['getTag'] }
  getTagPaginator: {
    Query: TagPaginator
    Response: TagPaginator
    Args: InputType['getTagPaginator']
  }
  deleteTag: { Query: Tag; Response: Tag; Args: InputType['deleteTag'] }
  createTag: { Query: Tag; Response: Tag; Args: InputType['createTag'] }
  ...
  deleteAlgTagLink: {
    Query: AlgTagLink
    Response: AlgTagLink
    Args: InputType['deleteAlgTagLink']
  }
  createAlgTagLink: {
    Query: AlgTagLink
    Response: AlgTagLink
    Args: InputType['createAlgTagLink']
  }
  getAllUserRole: {
