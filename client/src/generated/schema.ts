...
export type User={id:(Scalars['id']);provider:(never);provider_id:(never);wca_id:(Scalars['string']|null);email:(Scalars['string']);name:(Scalars['string']);avatar:(Scalars['string']|null);country:(Scalars['string']|null);is_public:(Scalars['boolean']);role:(Scalars['userRole']);created_at:(Scalars['unixTimestamp']);updated_at:(Scalars['unixTimestamp']|null);created_by:(User);__args:(Root["getUser"]["Args"]);}
